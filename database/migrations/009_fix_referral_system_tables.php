<?php
/**
 * Migration: Fix and create tables for the referral system
 */

class Migration_Fix_referral_system_tables extends CI_Migration {
    ...
    public function up() {
        ...
        // Create function to generate referral codes using a simpler approach
        $this->db->query("
            ...
            BEGIN
                ...
                -- If code exists, try again with a new random string
